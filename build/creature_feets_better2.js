...
function agentMove(act) {
    if (act == 1) {
        foot1moveForward = !foot1moveForward;
    }
    else if (act == 2) {
        foot1moveBackward = !foot1moveBackward;
    }
    else if (act == 3) {
        foot2moveForward = !foot2moveForward;
    }
    else if (act == 4) {
        foot2moveBackward = !foot2moveBackward;
    }
    else {
        stay='none';
    }
...
function wwwMove(act) {
    if (0 <= act <= 0.2) {
        www.body.moveForward(500);
    }
    else if (0.2 < act <= 0.4) {
        www.body.moveForward(500);
    }
    else if (0.4 < act <= 0.6) {
        www.body.rotateLeft(500);
    }
    else if (0.6 < act <= 0.8) {
        www.body.rotateRight(500);
    }
    else {
    }
}
...
function update() {
    ...
    s11=foot1moveForward;
    s12=foot2moveForward;
    s13=foot1moveBackward;
    s14=foot2moveBackward;
